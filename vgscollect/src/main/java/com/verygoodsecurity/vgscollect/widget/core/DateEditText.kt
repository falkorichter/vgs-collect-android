        ...
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                val aliasFormat = getInt(
                    R.styleable.ExpirationDateEditText_aliasFormat,
                    VGSVaultAliasFormat.UUID.ordinal
                )
                val storageType = getInt(
                    R.styleable.ExpirationDateEditText_storageType,
                    VGSVaultStorageType.PERSISTENT.ordinal
                )
                val enableTokenization =
                    getBoolean(R.styleable.ExpirationDateEditText_enableTokenization, true)
